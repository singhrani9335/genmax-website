...
export default function GraphicDesigningFaq() {
  const [openFaq, setOpenFaq] = useState<number | null>(0);

  return (
    <section className="w-full bg-white py-12 sm:py-14 lg:py-18 xl:py-20">
      <div className="mx-auto grid w-full max-w-[1400px] items-center gap-8 px-5 sm:px-8 md:grid-cols-2 lg:gap-12 lg:px-12 xl:px-16">
        ...
        <div className="relative">
          ...
          <div className="relative z-10 rounded-[4px] bg-[#17245C]/8 p-3 sm:p-4">
            <Image
              src={graphicDesigningFaq.image}
              alt={graphicDesigningFaq.imageAlt}
              width={750}
              height={650}
        ...
        {/* ================= RIGHT FAQ CARD ================= */}
        <div className="relative w-full min-w-0 overflow-hidden rounded-[4px] bg-[#17245C] p-5 shadow-[0_20px_50px_rgba(23,36,92,0.20)] sm:p-7 lg:p-8 xl:p-9">
          {/* ================= BACKGROUND GLOW ================= */}
          ...
          <div className="relative z-10 min-w-0">
            {/* ================= HEADING ================= */}
            <h2 className="mb-7 w-full text-[25px] font-medium uppercase leading-[1.2] tracking-[-0.4px] text-white sm:text-[27px] md:text-[28px] lg:text-[30px] xl:text-[32px]">
              {graphicDesigningFaq.title}
            </h2>

            {/* ================= FAQ LIST ================= */}
            <div className="w-full space-y-3">
              {graphicDesigningFaq.faqs.map((faq, index) => {

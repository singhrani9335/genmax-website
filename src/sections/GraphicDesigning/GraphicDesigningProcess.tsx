import { graphicDesigningProcess } from "@/data/graphicDesigning";

export default function GraphicDesigningProcess() {
  const steps = [
    {
      lineY: 55,
      top: 31,
    ...
    <section className="w-full overflow-hidden bg-white py-12 sm:py-16 lg:py-16 xl:py-20">
      <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="relative mx-auto hidden h-[760px] w-full max-w-[1200px] lg:block">
          ...
          {graphicDesigningProcess.map((step, index) => {
        ...
        <div className="relative lg:hidden">
          ...
          <div className="relative space-y-16 sm:space-y-20">
            {graphicDesigningProcess.map((step) => (
              <div
                key={step.number}

import { googleAdsProcess } from "@/data/googleAds";
  ...
  return (
    <section className="w-full overflow-hidden bg-white py-12 sm:py-16 lg:py-16 xl:py-20">
      <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        {/* ================= DESKTOP ================= */}
        <div className="relative mx-auto hidden h-[1590px] w-full max-w-[1200px] lg:block">
          {/* ================= BACKGROUND SVG LINES ================= */}
          <svg
            className="pointer-events-none absolute inset-0 z-0 h-full w-full"
            viewBox="0 0 1200 1590"

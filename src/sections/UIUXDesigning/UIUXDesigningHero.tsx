...
import { uiUxDesigningHero } from "@/data/uiUxDesigning";

export default function UIUXDesigningHero() {
    ...
    try {
      ...
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "UI/UX Designing Service Page",
        }),
      });
      ...
      console.error("UI/UX Designing form error:", error);
        ...
        <div className="flex flex-col lg:flex-row lg:items-start">
          ...
          <div className="w-full lg:w-[66%]">
            ...
            <div className="relative w-full overflow-hidden">
              <Image
                src={uiUxDesigningHero.image}
                alt={uiUxDesigningHero.imageAlt}
                width={1920}
                height={650}
                priority
          ...
          <div className="relative z-20 w-full lg:w-[34%]">
            ...
            <div className="relative min-h-[530px] w-full overflow-hidden bg-gradient-to-br from-[#080B12] via-[#101A42] to-[#173D91] px-6 py-8 shadow-[0_18px_45px_rgba(0,0,0,0.16)] sm:min-h-[550px] sm:px-7 sm:py-9 lg:min-h-[570px] lg:px-7 lg:py-9 xl:min-h-[580px] xl:px-8">
              ...
              <div className="relative z-10">
                ...
                <a
                  href={`tel:${uiUxDesigningHero.phoneLink}`}

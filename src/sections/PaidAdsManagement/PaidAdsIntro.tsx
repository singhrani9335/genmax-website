...
import { paidAdsIntro } from "@/data/paidAdsManagement";
    ...
    <section className="w-full bg-white py-8 sm:py-10 lg:py-14 xl:py-16">
      <div className="mx-auto grid w-full max-w-[1400px] items-start gap-8 px-5 sm:px-8 md:grid-cols-2 md:gap-10 lg:gap-14 lg:px-12 xl:px-16">
        ...
        <div className="relative w-full overflow-hidden">
          <Image
            src={paidAdsIntro.image}
            alt={paidAdsIntro.imageAlt}
            width={700}
            height={750}
            priority
        ...
        <div className="w-full pt-0">
          ...
          <div className="mt-4">
            {paidAdsIntro.paragraphs.map((paragraph, index) => (
              <p
                key={index}

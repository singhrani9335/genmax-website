import { webDevelopmentProcess } from "@/data/webDevelopment";
  ...
  return (
    <section className="w-full overflow-hidden bg-white py-12 sm:py-16 lg:py-16 xl:py-20">
      <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        {/* ================= DESKTOP ================= */}
        <div className="relative mx-auto hidden h-[1030px] w-full max-w-[1200px] lg:block">
        ...
        <div className="relative lg:hidden">
          ...
          <div className="relative space-y-14 sm:space-y-16">
            {webDevelopmentProcess.map((step) => (
              <div
                key={step.number}

...
import { webDevelopmentServices } from "@/data/webDevelopment";
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            ...
            <div className="mt-12 grid grid-cols-1 gap-x-16 gap-y-7 sm:grid-cols-2 lg:mt-14">
              {webDevelopmentServices.points.map((point, index) => {
          ...
          <div className="relative flex h-[280px] w-full items-center justify-center sm:h-[340px] lg:h-[380px]">
            <Image
              src={webDevelopmentServices.image}
              alt={webDevelopmentServices.imageAlt}
              fill
              priority

...
import { reputationManagementTools } from "@/data/reputationManagement";

export default function ReputationManagementTools() {
  return (
    <section className="w-full bg-white py-10 sm:py-12 lg:py-16">
      <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8 lg:px-12 xl:px-16">
        <Swiper
          ...
          className="w-full"
        >
          {reputationManagementTools.map((tool) => (
            <SwiperSlide key={`${tool.name}-${tool.image}`}>

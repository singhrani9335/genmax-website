...
import { mobileAppDevelopmentServices } from "@/data/mobileAppDevelopment";
        ...
        <div className="grid grid-cols-1 items-center gap-10 lg:grid-cols-2 lg:gap-16">
          ...
          <div>
            <h2 className="text-[30px] font-normal tracking-wide text-[#263B5A] sm:text-[36px] lg:text-[40px]">
              {mobileAppDevelopmentServices.title}
            </h2>

            {/* ================= POINTS ================= */}
            <div className="mt-12 grid grid-cols-1 gap-x-16 gap-y-7 sm:grid-cols-2 lg:mt-14">
              {mobileAppDevelopmentServices.points.map((point, index) => {
          ...
          <div className="relative flex h-[280px] w-full items-center justify-center sm:h-[340px] lg:h-[380px]">
            <Image
              src={mobileAppDevelopmentServices.image}
              alt={mobileAppDevelopmentServices.imageAlt}
              fill
              priority

import { mobileAppDevelopmentProcess } from "@/data/mobileAppDevelopment";

export default function MobileAppDevelopmentProcess() {
  const steps = [
    {
      lineY: 55,
      top: 31,
  ...
  return (
    <section className="w-full overflow-hidden bg-white py-12 sm:py-16 lg:py-16 xl:py-20">
      <div className="mx-auto w-full max-w-[1400px] px-5 sm:px-8 lg:px-12 xl:px-16">
        ...
        <div className="relative mx-auto hidden h-[1100px] w-full max-w-[1200px] lg:block">
          {/* =====================================================
          ...
          {mobileAppDevelopmentProcess.map((step, index) => {
              ...
              >
                <div className="grid grid-cols-[48px_minmax(0,1fr)] gap-5">
                  ...
                  <div className="w-[510px] xl:w-[540px]">
                    <h3 className="text-[18px] font-normal uppercase leading-[1.35] tracking-[0.8px] text-[#17245C] xl:text-[20px]">
                      {step.title}
                    </h3>

                    <p className="mt-3 text-[13px] leading-[1.75] text-[#56606B] xl:text-[14px]">
                      {step.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="relative lg:hidden">
          ...
          <div className="relative space-y-16 sm:space-y-20">
            {mobileAppDevelopmentProcess.map((step) => (
              <div
                key={step.number}
              ...
              >
                ...
                <div className="relative z-10 flex h-[48px] w-[48px] items-center justify-center rounded-full border border-[#F04D02] bg-white text-[18px] font-normal text-[#F04D02]">
                  {step.number}
                </div>
                ...
                <div className="pb-2">
                  <h3 className="text-[17px] font-normal uppercase leading-[1.4] tracking-[0.7px] text-[#17245C] sm:text-[19px]">
                    {step.title}
                  </h3>
